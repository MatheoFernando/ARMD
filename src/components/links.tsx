...
export function Links() {
  return (
    <div className="bg-cover bg-center bg-parallex02 py-8 ">
    
        <h1 className="flex items-center justify-center  font-bold text-2xl z-30 relative mb-8 ">
          LINKS
        </h1>
     
      <div className="container grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4 justify-items-center mt-6">
